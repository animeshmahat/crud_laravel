            ...
            <div class="col-12 px-3">
                <form action="{{ route( 'application.update', ['id'=>$data->id]) }}" method="PUT" enctype="multipart/form-data">
                    ...
                    <div class="m-3">
                        ...
                        <input class="form-control" name="email" id="email" placeholder="Enter Email" value="{{ $data->email }}">
                        @error('email')
                        <p class="validate m-1">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="m-3">
                        ...
                        <input type="text" class="form-control" name="phone" id="phone" placeholder="Enter Your Phone Number" value="{{ $data->phone }}">
                        @error('phone')
                        <p class="validate m-1">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="d-flex flex-row">
                        ...
                        <div class="form-check m-3">
                            ...
                            <input class="form-check-input" type="radio" @if($data->gender == 'male') checked @endif name="gender" id="radio1" value="male" checked="checked">
                        </div>
                        <div class="form-check m-3">
                            <label for="radio2" class="form-check-label">Female</label>
                            <input class="form-check-input" type="radio" @if($data->gender == 'female') checked @endif name="gender" id="radio2" value="female">
                        </div>
                        <div class="form-check m-3">
                            <label for="radio3" class="form-check-label">Others</label>
                            <input class="form-check-input" type="radio" @if($data->gender == 'other') checked @endif name="gender" id="radio3" value="other">
                        </div>
                        @error('gender')
                    ...
                    <button type="submit" class="btn btn-success m-3"><i class="fa fa-paper-plane" aria-hidden="true"></i> UPDATE</button>
